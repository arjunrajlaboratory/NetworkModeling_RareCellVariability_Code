...
function S_outpar = generateDataSensAna(nruns,n_species,maxgillespie,gen,data,ipar)
...
%         T_save = sprintf('T_outpar%d_%d_%d',n_species,istruc,kmem);
        S_save = sprintf('S_outparSensAna%dII_%d_%d_%d',ipar,n_species,istruc,kmem);
        
%         save(T_save,'T_outpar','-v7.3');
