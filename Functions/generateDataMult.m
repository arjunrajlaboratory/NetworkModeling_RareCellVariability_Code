...
%         fileID = fopen('/Volumes/MELANOMAII/Revisions/gillespie_bursts.txt','w');
        ...
        tok = make_param_mex_bursts_mult('gillespie_bursts.txt',...
    ...
    for kmem = 1:100
        ...
        for jruns = 1:10
            ...
            par_spec = S(10*kmem-10+jruns,:);
            par_rates = R(10*kmem-10+jruns,:);
            par_prop = P(10*kmem-10+jruns,:);
        ...
        S_save = sprintf('S_outparMult%d_%d_%d',n_species,istruc,kmem);
